...
//import org.compiere.grid.ed.PatientRegistration;
//import org.compiere.grid.ed.PatientRegistration;
...
public class VPatient extends Patient implements FormPanel, ActionListener, TableModelListener, VetoableChangeListener
{
	...
	private CButton btnNewPatient = new CButton("NEW PATIENT");
	...
	public void dynInit() throws Exception
	{
		...
		// Translation
		statusBar.setStatusLine("Double-click a record to view details ");
	...
	private void jbInit()
	{
		...
		orderLabel.setText("Patient List");
		...
		parameterPanel.add(btnNewPatient, new GridBagConstraints(2, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
				GridBagConstraints.NONE, new Insets(5, 5, 5, 5), 0, 0));
	...
	{
		if (e.getSource().equals(btnNewPatient))
		{
			//PatientRegistration patientRegistration = new PatientRegistration((Frame) null, 0);
			//AEnv.showCenterScreen(patientRegistration);
		}
	}
	...
	MouseListener doubleClicML = new MouseAdapter() {
		public void mouseClicked(MouseEvent me)
		{
			...
			if (me.getClickCount() == 2)
			{
				...
				//	PatientRegistration patientRegistration = new PatientRegistration((Frame) null,
				//		idColumn.getRecord_ID());
				//	AEnv.showCenterScreen(patientRegistration);
				} catch (Exception e)
				{
					e.printStackTrace();
