...
public class VDepartmentalRequest extends DepartmentalRequest
		implements FormPanel, ActionListener, TableModelListener, VetoableChangeListener
{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		{
			NewRequest newReq = new NewRequest((Frame) null, ZEnv.getHms_treatment_doc_ID(), ZEnv.getC_BPartner_ID());
			AEnv.showCenterScreen(newReq);
		...
		public void mouseClicked(MouseEvent me)
		{
			...
			if (me.getClickCount() == 2)
			{
				try
				{
					...
					ViewResults viewResults = new ViewResults((Frame) null, m_request_ID);
					AEnv.showCenterScreen(viewResults);
				} catch (Exception e)
				{
					e.printStackTrace();
				}
	...
	public void loadBPartner()
	{
		...
		Vector<Vector<Object>> data = getDepartmentalRequestData(whereClause);
