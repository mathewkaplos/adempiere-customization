...
public class DepartmentalResults
{
	...
	public static Vector<Vector<Object>> getDepartmentalRequestData(int hms_treatment_doc_ID)
	{
		Vector<Vector<Object>> data = new Vector();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		String sql = "SELECT hms_specimen_requests_id, req.created ,org.name,test.name ,req.done,"
				...
				+ " INNER JOIN adempiere.AD_Org org ON org.AD_Org_ID = req.AD_Org_ID"
				+ " INNER JOIN adempiere.hms_test test ON test.hms_test_ID = req.hms_test_ID"
				+ " WHERE req.hms_treatment_doc_id =" + hms_treatment_doc_ID + " ORDER BY req.created";
		try
		{
