...
public class ZLookupAutocompleter extends FieldAutoCompleter
{
			...
			MLookup m_lookup)
	{
		...
		//
		MTable table = MTable.get(Env.getCtx(), m_lookup.getTableName());
		...
		zLookup.addVetoableChangeListener(new VetoableChangeListener()
		{
			@Override
