...
public class Language implements Serializable
{
	 ...
	 */
	/**************************************************************************
	 * Languages http://www.ics.uci.edu/pub/ietf/http/related/iso639.txt
	 * Countries
	...
	/***
	 * System Languages. If you want to add a language, extend the array - or
	 * use the addLanguage() method.
	 **/
	static private Language[] s_languages = {
			new Language("English", AD_Language_en_US, Locale.US, null, null, MediaSize.NA.LETTER), // Base
																									// Language
			// ordered by locale
			// Not predefined Locales - need to define decimal Point and date
			// pattern (not sure about time)
			new Language("\uFE94\uFEF4\uFE91\uFEAE\uFECC\uFEDF\uFE8D (AR)", AD_Language_ar_TN, new Locale("ar", "TN"),
					new Boolean(true), "dd.MM.yyyy", MediaSize.ISO.A4),
			new Language("\u0411\u044A\u043B\u0433\u0430\u0440\u0441\u043A\u0438 (BG)", AD_Language_bg_BG,
					new Locale("bg", "BG"), new Boolean(false), "dd/MM/yyyy", MediaSize.ISO.A4),
			new Language("Catal\u00e0", AD_Language_ca_ES, new Locale("ca", "ES"), null, "dd/MM/yyyy",
					MediaSize.ISO.A4),
			new Language("Deutsch", AD_Language_de_DE, Locale.GERMANY, null, null, MediaSize.ISO.A4),
			new Language("Dansk", AD_Language_da_DK, new Locale("da", "DK"), new Boolean(false), "dd-MM-yyyy",
					MediaSize.ISO.A4),
			new Language("English (AU)", AD_Language_en_AU, new Locale("en", "AU"), null, "dd/MM/yyyy",
					MediaSize.ISO.A4),
			new Language("English (UK)", AD_Language_en_GB, Locale.UK, null, null, MediaSize.ISO.A4),
			new Language("English (CA)", AD_Language_en_CA, new Locale("en", "CA"), null, "MM/dd/yyyy",
					MediaSize.NA.LETTER), // Canadian English
			new Language("Espa\u00f1ol", AD_Language_es_ES, new Locale("es", "ES"), new Boolean(false), "dd/MM/yyyy",
					MediaSize.ISO.A4),
			new Language("Espa\u00f1ol (MX)", AD_Language_es_MX, new Locale("es", "MX"), new Boolean(true),
					"dd/MM/yyyy", MediaSize.NA.LETTER),
			new Language("Espa\u00f1ol (CO)", AD_Language_es_CO, new Locale("es", "ES"), new Boolean(false),
					"dd/MM/yyyy", MediaSize.NA.LETTER),
			new Language("Espa\u00f1ol (VE)", AD_Language_es_ES, new Locale("es", "ES"), new Boolean(false),
					"dd/MM/yyyy", MediaSize.ISO.A4),
			new Language("Espa\u00f1ol (EC)", AD_Language_es_ES, new Locale("es", "ES"), new Boolean(false),
					"dd/MM/yyyy", MediaSize.ISO.A4),
			new Language("Espa\u00f1ol (DO)", AD_Language_es_DO, new Locale("es", "DO"), new Boolean(true),
					"dd/MM/yyyy", MediaSize.ISO.A4),
			new Language("\u0395\u03bb\u03bb\u03b7\u03bd\u03b9\u03ba\u03ac (GR)", AD_Language_el_GR,
					new Locale("el", "GR"), new Boolean(false), "dd/MM/yyyy", MediaSize.ISO.A4),
			new Language("Farsi", AD_Language_fa_IR, new Locale("fa", "IR"), new Boolean(false), "dd-MM-yyyy",
					MediaSize.ISO.A4),
			new Language("Finnish", AD_Language_fi_FI, new Locale("fi", "FI"), new Boolean(true), "dd.MM.yyyy",
					MediaSize.ISO.A4),
			new Language("Fran\u00e7ais", AD_Language_fr_FR, Locale.FRANCE, null, null, // dd.MM.yy
					MediaSize.ISO.A4),
			new Language("Fran\u00e7ais (CA)", AD_Language_fr_CA, new Locale("fr", "CA"), new Boolean(true),
					"MM/dd/yyyy", // MM/dd/yy
					MediaSize.NA.LETTER),
			new Language("Hrvatski", AD_Language_hr_HR, new Locale("hr", "HR"), null, "dd.MM.yyyy", MediaSize.ISO.A4),
			new Language("Indonesia Bahasa", AD_Language_in_ID, new Locale("in", "ID"), new Boolean(false),
					"dd-MM-yyyy", MediaSize.ISO.A4),
			new Language("Italiano", AD_Language_it_IT, Locale.ITALY, null, null, // dd.MM.yy
					MediaSize.ISO.A4),
			new Language("\u65e5\u672c\u8a9e (JP)", AD_Language_ja_JP, Locale.JAPAN, null, null, MediaSize.ISO.A4),
			new Language("Malaysian", AD_Language_ms_MY, new Locale("ms", "MY"), new Boolean(false), "dd-MM-yyyy",
					MediaSize.ISO.A4),
			new Language("Magyar (HU)", AD_Language_hu_HU, new Locale("hu", "HU"), new Boolean(false), "yyyy.MM.dd",
					MediaSize.ISO.A4),
			new Language("Nederlands", AD_Language_nl_NL, new Locale("nl", "NL"), new Boolean(false), "dd-MM-yyyy",
					MediaSize.ISO.A4),
			new Language("Norsk", AD_Language_no_NO, new Locale("no", "NO"), new Boolean(false), "dd/MM/yyyy",
					MediaSize.ISO.A4),
			new Language("Polski", AD_Language_pl_PL, new Locale("pl", "PL"), new Boolean(false), "dd-MM-yyyy",
					MediaSize.ISO.A4),
			new Language("Portuguese (BR)", AD_Language_pt_BR, new Locale("pt", "BR"), new Boolean(false), "dd/MM/yyyy",
					MediaSize.ISO.A4),
			new Language("Rom\u00e2n\u0103", AD_Language_ro_RO, new Locale("ro", "RO"), new Boolean(false),
					"dd.MM.yyyy", MediaSize.ISO.A4),
			new Language("\u0420\u0443\u0441\u0441\u043a\u0438\u0439 (Russian)", AD_Language_ru_RU,
					new Locale("ru", "RU"), new Boolean(false), "dd-MM-yyyy", MediaSize.ISO.A4),
			new Language("Slovenski", AD_Language_sl_SI, new Locale("sl", "SI"), null, "dd.MM.yyyy", MediaSize.ISO.A4),
			new Language("\u0421\u0440\u043F\u0441\u043A\u0438 (RS)", AD_Language_sr_RS, new Locale("sr", "RS"), null,
					"dd.MM.yyyy", MediaSize.ISO.A4),
			new Language("Svenska", AD_Language_sv_SE, new Locale("sv", "SE"), new Boolean(false), "yyyy-MM-dd",
					MediaSize.ISO.A4),
			new Language("\u0e44\u0e17\u0e22 (TH)", AD_Language_th_TH, new Locale("th", "TH"), new Boolean(false),
					"dd/MM/yyyy", MediaSize.ISO.A4),
			new Language("Vi\u1EC7t Nam", AD_Language_vi_VN, new Locale("vi", "VN"), new Boolean(false), "dd-MM-yyyy",
					MediaSize.ISO.A4),
			// Need to have (Windows) Asian Language Pack installed to view
			// properly
			new Language("\u7b80\u4f53\u4e2d\u6587 (CN)", AD_Language_zh_CN, Locale.CHINA, null, "yyyy-MM-dd",
					MediaSize.ISO.A4),
	...
	/**************************************************************************
	 * Get Language. If language does not exist, create it on the fly assuming
	 * that it is valid
	 * 
	 * @param langInfo
	 *            either language (en) or locale (en-US) or display name
	...
	public static Language getLanguage(String langInfo)
	{
		...
		{
			if (lang.equals(s_languages[i].getName()) || lang.equals(s_languages[i].getLanguageCode())
	...
	{
		if (langInfo == null || langInfo.length() == 0 || langInfo.equals(s_languages[0].getName())
	 ...
	 * 
	 * @param name
	 *            - displayed value, e.g. English
	 * @param AD_Language
	 *            - the code of system supported language, e.g. en_US (might be
	 *            different than Locale - i.e. if the system does not support
	 *            the language)
	 * @param locale
	 *            - the Locale, e.g. Locale.US
	 * @param decimalPoint
	 *            true if Decimal Point - if null, derived from Locale
	 * @param javaDatePattern
	 *            Java date pattern as not all locales are defined - if null,
	 *            derived from Locale
	 * @param mediaSize
	 *            default media size
	 */
	public Language(String name, String AD_Language, Locale locale, Boolean decimalPoint, String javaDatePattern,
			MediaSize mediaSize)
	{
	 ...
	 * 
	 * @param javaDatePattern
	 *            for details see java.text.SimpleDateFormat, format must be
	 *            able to be converted to database date format by using the
	 *            upper case function. It also must have leading zero for day
	 *            and month.
	 */
	...
	/**
	 * Get (Short) Date Format. The date format must parseable by
	 * org.compiere.grid.ed.MDocDate i.e. leading zero for date and month
	 * 
	...
	public SimpleDateFormat getDateFormat()
	{
		if (m_dateFormat == null)
		{
			...
			if (m_dateFormat.toPattern().indexOf("yyyy") == -1)
			{
				...
				m_dateFormat.applyPattern("dd-MM-yyyy"); // Mathew
			}
	 ...
	 * 
	 * @return Date Time format MMM d, yyyy h:mm:ss a z -or- dd.MM.yyyy HH:mm:ss
	 *         z -or- j nnn aaaa, H' ?????? 'm' ????'
	 */
	public SimpleDateFormat getDateTimeFormat()
	{
		SimpleDateFormat retValue = (SimpleDateFormat) DateFormat.getDateTimeInstance(DateFormat.MEDIUM,
				DateFormat.LONG, m_locale);
		// log.finer("Pattern=" + retValue.toLocalizedPattern() + ", Loc=" +
		// retValue.toLocalizedPattern());
		return retValue;
	} // getDateTimeFormat
	...
	public String toString()
	{
		...
		sb.append(m_name).append(",Locale=").append(m_locale.toString()).append(",AD_Language=").append(m_AD_Language)
				.append(",DatePattern=").append(getDBdatePattern()).append(",DecimalPoint=").append(isDecimalPoint())
				.append("]");
		return sb.toString();
	} // toString
