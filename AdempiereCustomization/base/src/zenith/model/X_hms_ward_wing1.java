...
/** Generated Model for hms_ward_wing1
 *  @author Adempiere (generated) 
 *  @version Release 3.8.0 - $Id$ */
public class X_hms_ward_wing1 extends PO implements I_hms_ward_wing1, I_Persistent 
{
    ...
    public X_hms_ward_wing1 (Properties ctx, int hms_ward_wing1_ID, String trxName)
    {
      super (ctx, hms_ward_wing1_ID, trxName);
      /** if (hms_ward_wing1_ID == 0)
        {
			sethms_ward_block1_ID (0);
			sethms_ward_wing1_ID (0);
        } */
    }

    /** Load Constructor */
    public X_hms_ward_wing1 (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_hms_ward_wing1[")
	...
	public void sethms_ward_wing1_ID (int hms_ward_wing1_ID)
	{
		if (hms_ward_wing1_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_hms_ward_wing1_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_hms_ward_wing1_ID, Integer.valueOf(hms_ward_wing1_ID));
	}
